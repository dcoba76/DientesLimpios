...
public class Dentista
{
    ...
    private void AplicarReglasDeNegocioNombre(string nombre)
    {
        ...
        {
            throw new ExcepcionDeReglaDeNegocio("El nombre del dentista no puede estar vacío.");
        }
    }
    ...
    private void AplicarReglasDeNegocioEmail(Email email)
    {
        ...
        {
            throw new ExcepcionDeReglaDeNegocio("El email del dentista no puede estar vacío.");
        }
    }
}
